...
from .changedlinesperfile import changed_lines_per_file
from .reviewemailgroup import ReviewEmailGroup
from .reviewemail import indented
from .rendercommit import render_commit
from .types import ReviewEmail


async def generate(mail: ReviewEmail) -> bool:
...
async def handle_published(
    ...
    group = ReviewEmailGroup(event, await event.user, "newReview")
